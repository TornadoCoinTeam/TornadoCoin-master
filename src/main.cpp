...
int64 nChainStartTime = 1402659000;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        assert(block.hashMerkleRoot == uint256("0xccb93cb3d1a6bd4dfe9046586a6bf4e236a3aa2116fd947e6fe194e247c73763"));
