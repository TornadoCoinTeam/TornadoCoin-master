...
int64 nChainStartTime = 1402930800;
...
const string strMessageMagic = "TornadoCoin Signed Message:\n";
...
int64 GetProofOfStakeReward(int64 nCoinAge, unsigned int nBits, unsigned int nTime, int nHeight)
{
    ...
    nRewardCoinYear = MAX_TornadoCoin_PROOF_OF_STAKE;
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in TornadoCoin
    bool fStrictPayToScriptHash = true; // Always active in TornadoCoin
...
bool static Reorganize(CTxDB& txdb, CBlockIndex* pindexNew)
{
    ...
    // Delete redundant memory transactions that are in the connected brancuh
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "TornadoCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        assert(block.hashMerkleRoot == uint256("0xeee70d70d669c14d799b9ee4010c5efd823e6eda27944ad4b842af339e4632c5"));
